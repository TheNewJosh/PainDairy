...
@section('content')
    <div class="main-content position-relative max-height-vh-100 h-100">
        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6">
            ...
            <form class="row" method="POST" action="{{ route('reportpaindocadd')}}">
              @csrf
              <input type="hidden" name="id" value="{{ $data->id }}">
                ...
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      ...
                      <input type="text" name="where_hurt" value="{{ $data->where_hurt }}" readonly class="form-control">
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      <label class="form-label">What is the severity of your pain? </label>
                      <input type="number" max="10" min="1" name="severity" value="{{ $data->severity }}" readonly class="form-control">
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      <label class="form-label">What words best describe the pain you feel? </label>
                      <select name="describe_pain" readonly class="form-control">
                ...
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      ...
                      <select name="type_pain" readonly class="form-control">
                ...
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      ...
                      <select name="factor_pain" readonly class="form-control">
                ...
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      ...
                      <input type="text" name="pain_lasted" value="{{ $data->pain_lasted }}" readonly class="form-control">
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      <label class="form-label">What your diet-like?  </label>
                      <select name="what_diet" readonly class="form-control">
                ...
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      ...
                      <input type="text" name="what_medications" value="{{ $data->what_medications }}" readonly class="form-control">
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      <label class="form-label">Do you have any allergy? Please state </label>
                      <input type="text" name="have_allergy" value="{{ $data->have_allergy }}" readonly class="form-control">
                    </div>
                </div>
                <div class="col-12 col-xl-6">
                    <div class="input-group input-group-outline mb-3 is-filled">
                      <label class="form-label">Other Symptoms </label>
                      <input type="text" name="symptoms" value="{{ $data->symptoms }}" readonly class="form-control">
                    </div>
                </div>
